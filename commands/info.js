...
const info = new EmbedBuilder()
        .setTitle('About')
        .setDescription('[Invite nep to your server](https://discord.com/api/oauth2/authorize?client_id=1120680594624487426&permissions=263168&scope=bot%20applications.commands)')
        .setThumbnail('https://preview.redd.it/kt3311mn5bp01.png?auto=webp&s=e420455ca8880f533a66514151a197f0f89adce6')
        .addFields(
                { name: 'Bot Info', value: 'A bot to look up various information from the game Black Cover M.', inline: true},
